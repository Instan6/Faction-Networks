...
-- Vehicle purchases
Config.PlateFormat = "A11 AA1" -- https://docs.jgscripts.com/dealerships/plate-format
Config.HideVehicleStats = false

-- Test drives
Config.TestDrivePlate = "PREVIEW" -- This is a plate seed so it'll be random every time (read: https://docs.jgscripts.com/dealerships/plate-format)
...
Config.DisplayVehiclesPlate = "PREVIEW"
...
Config.DealershipLocations = {
  ...
  ["pdm"] = {
    ...
    openShowroom = {
      coords = vector3(-56.99, -1096.99, 26.42),
      size = 5
    },
    openManagement = {
      coords = vector3(-30.45, -1106.74, 26.42),
      size = 5
    },
    sellVehicle = {
    ...
    purchaseSpawn = vector4(-18.05, -1106.38, 26.67, 160.53),
    testDriveSpawn = vector4(-58.58, -1109.09, 26.44, 77.01),
    camera = {
      name = "Car",
      coords = vector4(-146.6166, -596.6301, 166.0, 270.0),
      positions = {5.0, 8.0, 12.0, 8.0}
  ...
  ["vip"] = {
    type = "self-service", -- or "owned", "self-service"
    openShowroom = {
      coords = vector3(-118.13, -381.45, 36.24),
      size = 5
    },
    openManagement = {
      coords = vector3(-30.45, -1106.74, 26.42),
    ...
    markers = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
    showroomJobWhitelist = {},
    showroomGangWhitelist = {}, -- VIP PERMS NEED TO BE SETUP
    societyPurchaseJobWhitelist = {},
    societyPurchaseGangWhitelist = {},
