...
Config.Companies.Services = {
    {
        ...
        bossRanks = { "inspector", "senior sergeant", "sergeant", "leading senior constable" }, -- ranks that can manage the company
        location = {
            name = "Melbourne West Police Station",
            coords = { 
                x = 428.9,
                y = -984.5,
            }
    ...
    },
    {
        ...
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"senior team manager", "team manager", "mica team manager"}, -- ranks that can manage the company
        location = {
    ...
    },
    {
        ...
        canCall = true, -- if true, players can call the company
        canMessage = true, -- if true, players can message the company
        bossRanks = {"chief officer", "deputy chief officer", "commander"}, -- ranks that can manage the company
        location = {
            name = "North Melbourne Fire Station",
            coords = {
                x = -336.6,
                y = -134.3
            }
...
Config.Locations = { -- Locations that'll appear in the maps app.
    {
        ...
        name = "Victoria Police",
        description = "Melbourne West Police Station",
        icon = "https://cdn-icons-png.flaticon.com/512/7211/7211100.png",
    },
    {
        position = vector2(304.2, -587.0),
        name = "Ambulance Victoria",
        description = "Royal Melbourne",
        icon = "https://cdn-icons-png.flaticon.com/128/1032/1032989.png",
    },
}
