return {
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ name = 'handcuffs_key', price = 0 },
			{ name = 'legshackles', price = 0 },
	...
	PoliceTacticalArmoury = {
		name = 'Police Tactical Armoury',
		groups = {
			['cirt'] = 0, ['port'] = 0
		},
		blip = {
			...
			-- Firearms & Ammo
			{ name = 'weapon_virtus_1', price = 0, metadata = { registered = true, serial = 'POL'} },
			{ name = 'weapon_virtus_2', price = 0, metadata = { registered = true, serial = 'POL'} },
			{ name = 'ammo-rifle', price = 0, },
			-- Melee
			{ name = 'zipties', price = 0 },
			{ name = 'legshackles', price = 0 },
			{ name = 'battering_ram_tool', price = 0 },
		}, locations = {
			vec3(451.51, -979.44, 30.68)
		}, targets = {
			{ loc = vec3(453.21, -980.03, 30.68), length = 0.5, width = 3.0, heading = 270.0, minZ = 30.5, maxZ = 32.0, distance = 6 }
