return {
    ...
    pauseMapText = 'Laneway Roleplay', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        enabled = false , -- FALSE FOR DEVELOPMENT-- This will enable or disable the built in discord rich presence.
